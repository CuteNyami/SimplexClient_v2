...
public class MotionBlur extends ModuleCreator {
    public static float f;

    public MotionBlur() {
        super("motionblur", 0,0);
    }
    ...
    public static float getMultiplier() {
        return Minecraft.getDebugFPS() > 120 ? (Minecraft.getDebugFPS() > 200 ? 60.0F : 30.0F) : 20.0F;
    }

    public static float getAccumulationValue() {
        f = getMultiplier() * 12.0F;
