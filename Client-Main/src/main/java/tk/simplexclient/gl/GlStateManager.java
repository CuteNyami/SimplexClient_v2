...
public class GlStateManager
{
    ...
    {
        alphaState.enabled.setDisabled();
    }

    public static void enableAlpha()
    {
        alphaState.enabled.setEnabled();
    }
    ...
    {
        blendState.enabled.setDisabled();
    }

    public static void enableBlend()
    {
        blendState.enabled.setEnabled();
    }
    ...
    {
        public GlStateManager.BooleanState enabled;
        public int func;
        public float ref;

        private AlphaState()
        {
            this.enabled = new GlStateManager.BooleanState(3008);
            this.func = 519;
            this.ref = -1.0F;
        }
    ...
    static class BlendState
    {
        ...
        private BlendState()
        {
            this.enabled = new GlStateManager.BooleanState(3042);
            this.srcFactor = 1;
            this.dstFactor = 0;
