...
public class ModButton extends GuiButton {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        ...
        SimplexClient.getInstance().getSmoothFont().drawCenteredString(this.displayString, (int) (this.xPosition + (float) this.width / 2), (int) (this.yPosition + (float) (this.height - 8) / 2), (int) b);
    }
