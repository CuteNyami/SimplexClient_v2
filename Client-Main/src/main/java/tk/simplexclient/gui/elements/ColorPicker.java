...
public class ColorPicker extends Gui {
    ...
    public ColorPicker(int x, int y, int width, int height, boolean alphaSlider, String text) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
    ...
    public void render(int mouseX, int mouseY) {
        ...
        SimplexClient.getInstance().getSmoothFont().drawString(text, pickerX, pickerY - 10, new Color(170, 170, 170).getRGB());
        ...
        // Shadow
        GLRectUtils.drawShadow(pickerX, pickerY, pickerWidth, pickerHeight);
        GLRectUtils.drawShadow(hueSliderX, hueSliderY, hueSliderWidth, hueSliderHeight);
        if (alphaSlider) {
            GLRectUtils.drawShadow(alphaSliderX, alphaSliderY, alphaSliderWidth, alphaSliderHeight);
        }
        ...
        GLRectUtils.drawShadow(selectedX, selectedY, selectedWidth, selectedHeight);
    ...
    public int getSelectedColorFinal() {
        return selectedColorFinal;
    }
